  ...
  <body>
      ...
      <div align="center">
        <div id="fond_formulaire" class="col-sm-6" align="center">
          ...
          <form form action="Sauvegarde_objet.php" method="post" id="formulaire_item" enctype="multipart/form-data" align="center">
            ...
            <table style="padding: 60px;" align="center" id="formulaire_nouvel_utilisateur">
              ...
              <tr id="date_fin" style="display: none;">
                ...
                <td>
                  <input id="date" type="date" name="type_vente" class="form-control">
                </td>
              </tr>
